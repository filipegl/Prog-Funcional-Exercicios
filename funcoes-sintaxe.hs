...
hoSumSquares x y = fst sqr + snd sqr
    where sqr = higherOrderSum square x y
...
-- Resposta: e.g. (+3) odd [1..10] = [5,7,9,11,13].
-- Pega a lista [1,,10] e soma 3 em cada elemento. Depois retorna apenas os elementos impares.
